...
- Gemini File API 지원 (토큰 절약, 대용량 파일 지원)
...
- **File API 모드**: 영상 목록 상단의 **"File API"** 체크박스를 활성화하면 Gemini File API를 통해 파일을 업로드한 뒤 변환합니다. 기존 방식(base64 직접 전송) 대비 토큰 사용량이 적고 대용량 파일을 지원합니다.
